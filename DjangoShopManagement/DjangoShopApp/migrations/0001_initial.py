    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added_on', models.DateTimeField(auto_now_add=True)),
                ('company_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DjangoShopApp.company')),
            ],
        ),
        migrations.CreateModel(
            name='ProductDetails',
            fields=[
                ...
                ('description', models.CharField(max_length=255)),
                ('added_on', models.DateTimeField(auto_now_add=True)),
                ('product_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DjangoShopApp.product')),
            ],
        ),
        migrations.CreateModel(
            name='EmployeeSalary',
            fields=[
                ...
                ('added_on', models.DateTimeField(auto_now_add=True)),
                ('employee_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DjangoShopApp.employee')),
            ],
        ),
        migrations.CreateModel(
            name='EmployeeBank',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added_on', models.DateTimeField(auto_now_add=True)),
                ('bill_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DjangoShopApp.bill')),
                ('product_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DjangoShopApp.product')),
            ],
        ),
        migrations.AddField(
            model_name='bill',
            name='customer_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DjangoShopApp.customer'),
        ),
    ]
